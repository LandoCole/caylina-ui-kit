...
const ca = (e, t) => {
  ...
  for (let d = 0; d < r; d++) {
    const h = e[d];
    let m, x, u = -1, $ = 0;
    for (; $ < h.length && (s.lastIndex = $, x = s.exec(h), x !== null); ) $ = s.lastIndex, s === dt ? x[1] === "!--" ? s = zr : x[1] !== void 0 ? s = Cr : x[2] !== void 0 ? (Fr.test(x[2]) && (a = RegExp("</" + x[2], "g")), s = Ee) : x[3] !== void 0 && (s = Ee) : s === Ee ? x[0] === ">" ? (s = a ?? dt, u = -1) : x[1] === void 0 ? u = -2 : (u = s.lastIndex - x[2].length, m = x[1], s = x[3] === void 0 ? Ee : x[3] === '"' ? Sr : Or) : s === Sr || s === Or ? s = Ee : s === zr || s === Cr ? s = dt : (s = Ee, a = void 0);
    const _ = s === Ee && e[d + 1].startsWith("/>") ? " " : "";
    i += s === dt ? h + sa : u >= 0 ? (o.push(m), h.slice(0, u) + Lr + h.slice(u) + he + _) : h + he + (u === -2 ? d : _);
  }
...
class ft {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, s = 0;
    const d = t.length - 1, h = this.parts, [m, x] = ca(t, r);
    if (this.el = ft.createElement(m, o), Pe.currentNode = this.el.content, r === 2 || r === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (a = Pe.nextNode()) !== null && h.length < d; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const u of a.getAttributeNames()) if (u.endsWith(Lr)) {
          const $ = x[s++], _ = a.getAttribute(u).split(he), k = /([.?@])?(.*)/.exec($);
          h.push({ type: 1, index: i, name: k[2], strings: _, ctor: k[1] === "." ? pa : k[1] === "?" ? ha : k[1] === "@" ? ua : qt }), a.removeAttribute(u);
        } else u.startsWith(he) && (h.push({ type: 6, index: i }), a.removeAttribute(u));
        if (Fr.test(a.tagName)) {
          const u = a.textContent.split(he), $ = u.length - 1;
          if ($ > 0) {
            a.textContent = Ft ? Ft.emptyScript : "";
            for (let _ = 0; _ < $; _++) a.append(u[_], ut()), Pe.nextNode(), h.push({ type: 2, index: ++i });
            a.append(u[$], ut());
          }
        }
      } else if (a.nodeType === 8) if (a.data === Rr) h.push({ type: 2, index: i });
      else {
        let u = -1;
        for (; (u = a.data.indexOf(he, u + 1)) !== -1; ) h.push({ type: 7, index: i }), u += he.length - 1;
      }
      i++;
    }
  }
...
class da {
  ...
  u(t) {
    ...
    Pe.currentNode = a;
    let i = Pe.nextNode(), s = 0, d = 0, h = o[0];
    for (; h !== void 0; ) {
      if (s === h.index) {
        let m;
        h.type === 2 ? m = new _t(i, i.nextSibling, this, t) : h.type === 1 ? m = new h.ctor(i, h.name, h.strings, this, t) : h.type === 6 && (m = new va(i, this, t)), this._$AV.push(m), h = o[++d];
      }
...
class qt {
  ...
  _$AI(t, r = this, o, a) {
    ...
    if (i === void 0) t = Ge(this, t, r, 0), s = !vt(t) || t !== this._$AH && t !== ue, s && (this._$AH = t);
      ...
      const d = t;
      let h, m;
      for (t = i[0], h = 0; h < i.length - 1; h++) m = Ge(this, d[o + h], r, h), m === ue && (m = this._$AH[h]), s ||= !vt(m) || m !== this._$AH[h], m === c ? t = c : t !== c && (t += (m ?? "") + i[h + 1]), this._$AH[h] = m;
    }
    s && !a && this.j(t);
  }
  j(t) {
...
var Ta = Object.defineProperty, ja = Object.getOwnPropertyDescriptor, Ut = (e, t, r, o) => {
...
let y = class extends f {
  ...
  _renderSortIcon(e) {
    ...
    return n`
      <span class="sort-icon">
        ...
        <span class=${p({ "sort-desc": !0, active: o })}>
          <svg width="10" height="6" viewBox="0 0 10 6" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M1 1L5 5L9 1"/>
          </svg>
        </span>
          ...
          ${r ? c : n`
                ...
                >
                  ...
                  <div class="grid-header">
                    ...
                    ${this.columns.map(
        (o) => n`
                        <div class=${p({ cell: !0, sortable: !!o.sortable })} data-col=${o.key} @click=${() => this._handleSort(o)}>
                  ...
                  <!-- Rows -->
                  ${t.rows.length === 0 ? n`<div class="empty" style="grid-column:1/-1">No tasks in this group</div>` : t.rows.map((o, a) => this._renderRowTree(o, a, e, 0))}
                </div>
  ...
  _renderRowTree(e, t, r, o = 0) {
    const a = this.expandable && (e.children?.length ?? 0) > 0, i = this.expandedIds.includes(e.id);
    return n`
      ${this._renderRow(e, t, r, o)}
      ${a && i ? e.children.map((s, d) => this._renderRowTree(s, d, r, o + 1)) : c}
    `;
  }
  _renderRow(e, t, r, o = 0) {
    const a = o > 0, i = this.selectedIds.includes(e.id), s = this._dragRowId === e.id, d = this._dragOverRowId === e.id && this._dragOverPosition === "above", h = this._dragOverRowId === e.id && this._dragOverPosition === "below", m = this.expandable && (e.children?.length ?? 0) > 0, x = this.expandedIds.includes(e.id);
    return n`
      <div
        class=${p({
      "grid-row": !0,
      ...
      >
        ${this.expandable ? n`
            ...
            ` : c}
        ${this.draggable ? a ? n`<div class="cell cell-checkbox"></div>` : n`
              <div class="cell cell-checkbox">
                <span
                  class="drag-handle"
            ...
            ` : c}
        ${this.selectable ? a ? n`<div class="cell cell-checkbox"></div>` : n`
              <div class="cell cell-checkbox">
      ...
      (u, $) => n`
            <div
              class="cell ${a && $ === 0 ? "child-indent" : ""}"
              style=${a && $ === 0 ? `--_depth:${o}` : c}
            >${this._renderCell(u, e)}</div>
          `
    )}
        ${r ? a ? n`<div class="cell cell-actions"></div>` : n`
...
let ge = class extends f {
  ...
  _renderBarChart() {
    ...
    const r = 600, o = 300, a = { top: 20, right: 20, bottom: 40, left: 50 }, i = r - a.left - a.right, s = o - a.top - a.bottom, d = t.flatMap((_) => _.data), h = Math.max(...d, 1), m = i / e.length, x = m / (t.length + 1), u = 5, $ = h / u;
    return n`
      <svg viewBox="0 0 ${r} ${o}">
  ...
  _renderLineChart() {
    const { labels: e, datasets: t } = this.data;
    if (!e.length || !t.length) return c;
    const r = 600, o = 300, a = { top: 20, right: 20, bottom: 40, left: 50 }, i = r - a.left - a.right, s = o - a.top - a.bottom, d = t.flatMap(($) => $.data), h = Math.max(...d, 1), m = i / Math.max(e.length - 1, 1), x = 5, u = h / x;
    return n`
      <svg viewBox="0 0 ${r} ${o}">
        <g transform="translate(${a.left}, ${a.top})">
          <!-- Grid -->
  ...
  _renderPieChart() {
    ...
    const t = e[0].data, r = this.data.labels, o = t.reduce((x, u) => x + u, 0);
    if (o === 0) return c;
    const a = 150, i = 150, s = 120, d = this.type === "doughnut" ? s * 0.6 : 0;
    let h = -Math.PI / 2;
    const m = t.map((x, u) => {
      const $ = x / o * 2 * Math.PI, _ = h + $, k = $ > Math.PI ? 1 : 0, O = a + s * Math.cos(h), I = i + s * Math.sin(h), Y = a + s * Math.cos(_), De = i + s * Math.sin(_);
      let ct = "";
      if (d > 0) {
        const At = a + d * Math.cos(h), Yr = i + d * Math.sin(h), Qr = a + d * Math.cos(_), Gr = i + d * Math.sin(_);
        ...
        <div class="timeline">
          <div class="timeline-inner" style="width:${r}px; --col-width:${t}px">
            ...
            <div class="timeline-header">
              ${e.map((i) => {
      const s = this._formatDateLabel(i), d = i.getTime() === o.getTime(), h = this._isWeekend(i);
...
let z = class extends f {
  ...
  _getDayClasses(e, t) {
    const r = tr(e), a = X(r, /* @__PURE__ */ new Date()), i = !e.isCurrentMonth, s = Tt(r, this._parsedMin, this._parsedMax);
    let d = !1, h = !1, m = !1, x = !1;
    if (this.mode === "single") {
  ...
  render() {
    ...
    return n`
      ...
      (r) => n`<span class="weekday" role="columnheader">${r}</span>`
              ...
              >
                ${t.map((r, o) => {
      const a = tr(r), i = Tt(a, this._parsedMin, this._parsedMax), s = this._getDayClasses(r, o);
      return n`
                    <button
                      type="button"
                      data-cell=${o}
...
const xr = class xr extends f {
  ...
  _renderDropdown() {
    return n`
      ...
      return n`
            <button
              class=${p({ option: !0, selected: o, focused: r === this._focusedIndex })}
              role="option"
              aria-selected=${o}
              @click=${(a) => {
...
let E = class extends f {
  ...
  get _allRows() {
    const e = [], t = (r) => {
      if (e.push(r), r.children) for (const o of r.children) t(o);
    };
    for (const r of this.groups)
      for (const o of r.rows) t(o);
    return e;
  }
...
let Ne = class extends f {
  ...
  _renderTimeline() {
    return this.periods.map((e) => {
      ...
      if (!t || !r || !o || !a) return c;
      const i = r.getTime() - t.getTime(), s = i > 0 ? (o.getTime() - t.getTime()) / i * 100 : 0, d = i > 0 ? (r.getTime() - a.getTime()) / i * 100 : 0, h = jr(o, a);
      return n`
...
var Ai = Object.defineProperty, Ti = Object.getOwnPropertyDescriptor, Gt = (e, t, r, o) => {
...
var ji = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, It = (e, t, r, o) => {
