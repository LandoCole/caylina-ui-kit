...
class po {
  ...
  u(t) {
    ...
    Pe.currentNode = o;
    let i = Pe.nextNode(), s = 0, d = 0, p = a[0];
    for (; p !== void 0; ) {
      if (s === p.index) {
        let x;
    ...
    return n`
      ...
      return n`
        ...
        (a) => n`
                  ...
                  <!-- Rows -->
                  ${t.rows.length === 0 ? n`<div class="empty" style="grid-column:1/-1">No tasks in this group</div>` : t.rows.map((a, o) => n`
                        ${this._renderRow(a, o, e)}
                        ${this.expandable && (a.children?.length ?? 0) > 0 && this.expandedIds.includes(a.id) ? a.children.map((i, s) => this._renderChildRow(i, s, e)) : c}
                      `)}
                </div>
    ...
    return n`
      ...
      (t) => n`
        ...
        ${this.rows.length === 0 ? n`<div class="empty" style="grid-column:1/-1">No data</div>` : this.rows.map((t, r) => n`
              ...
              ${this.expandable && (t.children?.length ?? 0) > 0 && this.expandedIds.includes(t.id) ? t.children.map((a, o) => this._renderChildRow(a, o, e)) : c}
            `)}
      </div>
    `;
  }
  _renderRow(e, t, r) {
    const a = this.selectedIds.includes(e.id), o = this._dragRowId === e.id, i = this._dragOverRowId === e.id && this._dragOverPosition === "above", s = this._dragOverRowId === e.id && this._dragOverPosition === "below", d = this.expandable && (e.children?.length ?? 0) > 0, p = this.expandedIds.includes(e.id);
    return n`
      <div
        class=${h({
      "grid-row": !0,
  ...
  _renderChildRow(e, t, r) {
    return n`
      <div class="grid-row child-row" data-row-id=${e.id}>
        ...
        ${this.columns.map(
      (a, o) => n`
            <div class="cell ${o === 0 ? "child-indent" : ""}">${this._renderCell(a, e)}</div>
          `
    )}
...
let ge = class extends v {
  ...
  _renderPieChart() {
    ...
    const x = t.map((m, f) => {
      ...
      let ct = "";
      if (d > 0) {
        const At = o + d * Math.cos(p), Yr = i + d * Math.sin(p), Qr = o + d * Math.cos(_), Gr = i + d * Math.sin(_);
        ...
        <div class="timeline">
          <div class="timeline-inner" style="width:${r}px; --col-width:${t}px">
            ...
            <div class="timeline-header">
              ${e.map((i) => {
      const s = this._formatDateLabel(i), d = i.getTime() === a.getTime(), p = this._isWeekend(i);
...
let Ne = class extends v {
  ...
  _renderTimeline() {
    return this.periods.map((e) => {
      ...
      if (!t || !r || !a || !o) return c;
      const i = r.getTime() - t.getTime(), s = i > 0 ? (a.getTime() - t.getTime()) / i * 100 : 0, d = i > 0 ? (r.getTime() - o.getTime()) / i * 100 : 0, p = Tr(a, o);
      return n`
